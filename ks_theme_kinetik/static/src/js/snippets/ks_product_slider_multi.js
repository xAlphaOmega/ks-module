odoo.define('ks_ecommerce_theme.product_slider_multi', function(require) {
    "use strict";
                     ...
                     var select = $("<select></select>").attr("id", "ks_slider_selection").attr("name", "Selection slider");
                          ...
                          var ks_slider_id = "#product-owl-id-"+(json.id)
                           ...
                           if(select.find("option").length){
                            ...
                            $(modal.$el).empty()
                            $(modal.$el).append(_t("No Sliders For this page"));
                         }
    ...
    options.registry.product_slider_actions = options.Class.extend({
        on_prompt:function(ks_self){
                ...
                dialog.on('save', this, function () {
                     ...
                     var ks_new_slider = new animation.registry.website_sale_product_slider(ks_self);
