(function() {
    ...
    this.WOW = function() {
        ...
        i.prototype.init = function() {
            ...
            this.boxes.length)
                return this.disabled() ? this.resetStyle() : "interactive" === (t = document.readyState) || "complete" === t ? this.start() : document.addEventListener("DOMContentLoaded", this.start)
        }
        ,
        i.prototype.start = function() {
            var t, e, i, n;
            for (e = 0,
            i = (n = this.boxes).length; e < i; e++)
                t = n[e],
                this.applyStyle(t, !0);
        ...
        i.prototype.applyStyle = function(t, e) {
            ...
            t.setAttribute("style", this.customStyle(e, n, i, o))
        }
        ,
        ...
        i.prototype.customStyle = function(t, e, i, n) {
            var o;
            return o = t ? "visibility: hidden; -webkit-animation-name: none; -moz-animation-name: none; animation-name: none;" : "visibility: visible;",
            e && (o += "-webkit-animation-duration: " + e + "; -moz-animation-duration: " + e + "; animation-duration: " + e + ";"),
            i && (o += "-webkit-animation-delay: " + i + "; -moz-animation-delay: " + i + "; animation-delay: " + i + ";"),
            n && (o += "-webkit-animation-iteration-count: " + n + "; -moz-animation-iteration-count: " + n + "; animation-iteration-count: " + n + ";"),
            o
        }
        ,
        ...
        i.prototype.isVisible = function(t) {
            ...
            o = (s = window.pageYOffset) + this.element.clientHeight - i,
        ...
        i.prototype.disabled = function() {
            return !1 === this.config.mobile && this.util().isMobile(navigator.userAgent)
        }
        ,
        i
    }()
